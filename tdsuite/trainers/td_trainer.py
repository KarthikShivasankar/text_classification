    ...
    def train_with_cross_validation(
        ...
        for fold_idx, (train_idx, val_idx) in enumerate(kf.split(train_dataset.labels)):
            ...
            fold_training_args = TrainingArguments(
                ...
                evaluation_strategy=(
                    "no" if eval_dataset is None else ta.evaluation_strategy
                ),
            ...
            fold_trainer = TDTrainer(
                ...
                output_dir=fold_output_dir,
                track_emissions=False,  # disabled for individual folds
        ...
        if emissions_tracker is not None:
            try:
                ...
                tracker_path = os.path.join(
                    emissions_dir, "cross_validation_emissions.json"
                )
                ...
                print(
                    f"\n🌱 Total carbon emissions for cross-validation: "
                    f"{emissions_value:.6f} kgCO2e"
                )
